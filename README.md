...
## 1. Class
Pada program ini terdapat class utama `Car` yang dibuat sebagai **abstract class** Class ini menyimpan atribut umum dqari sebuah mobil seperti:
...
Contructor ini dipanggil oleh class turunan menggunakan keywoard `super`.
...
Keywoard `super()` digunakan untuk memanggil constructor dari parent class.

---

# 4 Pillar OOP ( Object Oriented Programming)

## 1. Encapsulation
Encapsulation adlaah konsep **menyembunyikan data penting di dalam class menggunakan `private`**, lalu menyediakan akses melalui method seperti getter.
...
## 4. Polymorphism
Polymorphism adalah konsep dimana **method yang sama dapat memiliki perilaku yang berbeda tergantung objek yang memanggilnya**.
...
# Ringkasan 4 Pillar OOP pada program
